...
## 3. Canonical snapshot 갱신

```sh
npm run save-snapshot -- --stage components --from design/operations/components-refresh-YYYYMMDD/snapshot-components.json
```
